...
if args.targetEncryption == "CHITUF":
    ...
    lerdge_encrypt(args.sourceFile, args.outputDirectory, '/Lerdge_X_firmware_force.bin')
elif args.targetEncryption == "LERDGEK":
    lerdge_encrypt(args.sourceFile, args.outputDirectory, '/Lerdge_K_firmware_force.bin')
